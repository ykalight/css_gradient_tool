...
function UsingCss() {
  ...
  // const [picker, setPicker] = useState(['#165bcf', '#276de2', '#639efe', '#7da7ee', '#64d9d2', '#97e9e3', '#bb6bd9', '#b382e0', '#e6cefd', '#ff9966', '#fbcf36', '#fff200'])

  const glowstyle = {
    position: 'absolute',
    transformOrigin: `${originX} ${originY}`,
    backgroundImage: `linear-gradient(to right, ${picker[0]}, ${picker[1]}, ${picker[2]}, ${picker[3]}, ${picker[4]}, ${picker[5]}, ${picker[6]}, ${picker[7]}, ${picker[8]}, ${picker[9]}, ${picker[10]}, ${picker[11]})`,
